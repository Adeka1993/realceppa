...
from .models import Afijo, Delegacion , Perfil, TipoSocio, GrupoTrabajo, MotivoBajaUsuario
from general.models import Tratamiento , Provincia, Region, Pais
...
class DelegacionForm(forms.ModelForm):
    ...
    class Meta:
        model = Delegacion
        fields = ['nombre', 'direccion', 'codigoPostal','poblacion','provincia','email','url','telefono', 
        'vocalCria']
        widgets = {
...
class AfijoForm(forms.ModelForm):
